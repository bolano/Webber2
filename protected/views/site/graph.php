...
<?php $this->widget('bootstrap.widgets.TbButtonGroup', array(
    ...
    'buttons' => array(
        array('label'=>'Raw', 'url'=>'index.php?r=site/graph&linktype=0'),
        array('label'=>'Group by company', 'url'=>'index.php?r=site/graph&linktype=1'),
        array('label'=>'Group by news', 'url'=>'index.php?r=site/graph&linktype=2'),
        //array('label'=>'Group by address', 'url'=>'#'),
    ),
)); ?>
